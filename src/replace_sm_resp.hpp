 ...
 */
#ifndef __SMPP_REPLACE_SM_RESP_HPP__
#define __SMPP_REPLACE_SM_RESP_HPP__

/// @file replace_sm_resp.hpp
/// @brief An SMPP replace_sm_resp PDU.
...
namespace Smpp {
    ...
    /// @class ReplaceSmResp
    /// @brief Definition of an SMPP replace_sm_resp, derived from a Response.
    class ReplaceSmResp : public Response {
        Smpp::Buffer buff_;

      public:
        /// replace_sm_resp minimum length in octets.
        ...
        ReplaceSmResp(const CommandStatus& commandStatus,
                    const SequenceNumber& sequenceNumber);

        /// @brief Construct from a buffer.
        ReplaceSmResp(const Smpp::Uint8* b);

        /// @brief Destructor - does nothing.
        ~ReplaceSmResp() = default;
