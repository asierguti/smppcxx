 ...
 */
/// @file generic_nack.cpp
/// @brief Declares a generic_nack

#include "generic_nack.hpp"
...
Smpp::GenericNack::GenericNack(const CommandStatus& commandStatus,
...
Smpp::GenericNack::GenericNack(const Smpp::Uint8* b) :
    Response(CommandLength(MinLength),
              CommandId(CommandId::GenericNack),
              CommandStatus(CommandStatus::ESME_ROK),
              SequenceNumber(1))
...
void
Smpp::GenericNack::decode(const Smpp::Uint8* buff)
{
