 ...
 */
#ifndef __SMPP_BIND_TRANSCEIVER_HPP__
#define __SMPP_BIND_TRANSCEIVER_HPP__

/// @file bind_transceiver.hpp
/// @brief An SMPP bind_transceiver PDU.
...
namespace Smpp {
    ...
    /// @brief Definition of an SMPP bind_transceiver, derived from a Request.
