 ...
 */
/// @file bind_transmitter.cpp
/// @brief Declares a bind_transmitter

#include "bind_transmitter.hpp"

/// @brief Default constructor.
/// @note Sets all parameters to their default values.
Smpp::BindTransmitter::BindTransmitter() :
...
Smpp::BindTransmitter::BindTransmitter(const Smpp::Uint8* b) :
    Request(CommandLength(MinLength),
    CommandId(CommandId::BindTransmitter),
    SequenceNumber(1))
{
...
void
Smpp::BindTransmitter::decode(const Smpp::Uint8* buff)
{
    Request::decode(buff);
