 ...
 */
#ifndef __SMPP_BIND_TRANSMITTER_RESP_HPP__
#define __SMPP_BIND_TRANSMITTER_RESP_HPP__

/// @file bind_transmitter_resp.hpp
/// @brief An SMPP bind_transmitter_resp PDU.
...
namespace Smpp {
    ...
    /// @brief Definition of an SMPP bind_transmitter_resp, derived from a Response.
    class BindTransmitterResp : public Response {
        SystemId system_id_;

        Smpp::Buffer buff_;

      public:
        /// bind_transmitter_resp minimum length in octets.
