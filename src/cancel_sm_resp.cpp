 ...
 */
/// @file cancel_sm_resp.cpp
/// @brief Declares a cancel_sm_resp
...
Smpp::CancelSmResp::CancelSmResp(const CommandStatus& commandStatus,
...
Smpp::CancelSmResp::CancelSmResp(const Smpp::Uint8* b) :
    Response(CommandLength(MinLength),
              CommandId(CommandId::CancelSmResp),
              CommandStatus(CommandStatus::ESME_ROK),
              SequenceNumber(1))
...
void
Smpp::CancelSmResp::decode(const Smpp::Uint8* buff)
{
