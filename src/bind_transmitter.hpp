 ...
 */
#ifndef __SMPP_BIND_TRANSMITTER_HPP__
#define __SMPP_BIND_TRANSMITTER_HPP__

/// @file bind_transmitter.hpp
/// @brief An SMPP bind_transmitter PDU.
...
namespace Smpp {
    ...
    /// @brief Definition of an SMPP bind_transmitter, derived from a Request.
    class BindTransmitter : public Request {
        SystemId system_id_;
        Password password_;
      ...
      public:
        ...
        BindTransmitter(const Smpp::Uint8* b);

        /// @brief Destructor - does nothing.
        ~BindTransmitter() = default;
