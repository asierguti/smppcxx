 ...
 */
#ifndef __SMPP_DELIVER_SM_HPP__
#define __SMPP_DELIVER_SM_HPP__

/// @file deliver_sm.hpp
/// @brief An SMPP deliver_sm PDU.
...
namespace Smpp {
    ...
    /// @class DeliverSm
    /// @brief Definition of an SMPP deliver_sm, derived from a Request.
    class DeliverSm : public Request {
      ...
      public:
        /** deliver_sm minimum length in octets */
