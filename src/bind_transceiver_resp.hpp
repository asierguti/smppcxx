 ...
 */
#ifndef __SMPP_BIND_TRANSCEIVER_RESP_HPP__
#define __SMPP_BIND_TRANSCEIVER_RESP_HPP__

/// @file bind_transceiver_resp.hpp
/// @brief An SMPP bind_transceiver_resp PDU.
...
namespace Smpp {
    ...
    /// @brief Definition of an SMPP bind_transceiver_resp, derived from a Response.
    class BindTransceiverResp : public Response {
      ...
      public:
        /// bind_transceiver_resp minimum length in octets.
        ...
        BindTransceiverResp(const Smpp::Uint8* b);

        /// @brief Destructor - does nothing.
        ~BindTransceiverResp() = default;
