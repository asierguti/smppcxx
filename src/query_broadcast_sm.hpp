 ...
 */
#ifndef __SMPP_QUERY_BROADCAST_SM_HPP__
#define __SMPP_QUERY_BROADCAST_SM_HPP__

/// @file query_broadcast_sm.hpp
/// @brief An SMPP query_broadcast_sm PDU.
...
namespace Smpp {
    ...
    /// @brief Definition of an SMPP query_broadcast_sm, derived from a Request.
    class QueryBroadcastSm : public Request {
      ...
      public:
        /** query_broadcast_sm minimum length in octets */
        ...
        QueryBroadcastSm(const SequenceNumber& sequenceNumber,
                          MessageId&& messageId,
                          SmeAddress&& sourceAddr);

        /// @brief Construct from a buffer.
        QueryBroadcastSm(const Smpp::Uint8* b);
