 ...
 */
#ifndef __SMPP_DELIVER_SM_RESP_HPP__
#define __SMPP_DELIVER_SM_RESP_HPP__

/// @file deliver_sm_resp.hpp
/// @brief An SMPP deliver_sm_resp PDU.
...
namespace Smpp {
    ...
    /// @class DeliverSmResp
    /// @brief Definition of an SMPP deliver_sm_resp, derived from a Response.
    class DeliverSmResp : public Response {
      ...
      public:
        /// deliver_sm_resp minimum length in octets.
        ...
        DeliverSmResp(const Smpp::Uint8* b);
